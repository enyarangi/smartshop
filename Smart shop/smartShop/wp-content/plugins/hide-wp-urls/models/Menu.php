    ...
    public function addSubmenu($param = null) {
        ...
        if (is_array($this->menu)) {
            ...
            if ($this->menu[0] <> '' && $this->menu[1] <> '') {
                /* add the translation */
                $this->menu[0] = __($this->menu[0], _HMU_PLUGIN_NAME_);
                $this->menu[1] = __($this->menu[1], _HMU_PLUGIN_NAME_);
    ...
    public function addOption($param = null) {
        ...
        if (is_array($this->meta)) {
            ...
            if ($this->meta[0] <> '' && $this->meta[1] <> '') {
                /* add the translation */
                $this->meta[1] = __($this->meta[1], _HMU_PLUGIN_NAME_);
